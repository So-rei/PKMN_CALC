...
namespace PKMN_CALC.Master
{
    ...
    public static class _Master_Data
    {
        ...
        //公開する各種マスタプロパティ
        public static IEnumerable<Master_Pokemon> MASTER_POKEMON_LIST { get; internal set; }
        //public List<Master_Ability> cMaster_Ability;
        public static IEnumerable<Master_Item> MASTER_ITEM_LIST { get; internal set; }
        public static IEnumerable<Master_Rank> MASTER_RANK_LIST { get; internal set; }
        public static IEnumerable<Master_Seikaku> MASTER_SEIKAKU_LIST { get; internal set; }
        public static IEnumerable<Master_Type> MASTER_TYPE_LIST { get; internal set; }
        public static IEnumerable<Master_Waza> MASTER_WAZA_LIST { get; internal set; }
        //覚える技マスタはポケモンマスタ、わざマスタを参照するのでその２つの後にロードすること！
        public static IEnumerable<Master_EachPokeCanUseWaza> MASTER_EACHWAZA_LIST { get; internal set; }
        ...
        /// </summary>
        /// <param name="m_id"></param>
        /// <param name="cMT">セットしたいデータ(IEnumerable<T>を実装していること)</param>
